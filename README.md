...
endpoint 후보, 필드 매핑, 누락 필드, 정규화 후보와 한계 보고서는
[`docs/poc/kra-api/README.md`](./docs/poc/kra-api/README.md)에서 확인합니다. 실제 호출용
공통 CLI는 `npm run poc:kra -- ...` 형식으로 실행하며 화면 개발과는 분리되어 있습니다.
