...
const ENDPOINT = "https://apis.data.go.kr/B551015/API8_2/raceInfo";
...
main().catch((error: unknown) => {
  console.error(
    error instanceof Error ? error.message : "경주 정보 PoC에서 알 수 없는 오류가 발생했습니다.",
  );
  process.exitCode = 1;
});
